...
func (s *MarkPausingStep) IsComplete(ctx context.Context, input *PauseInput, state *PauseState) (bool, error) {
	...
	return state.Actor.GetStatus() == runtimeapipb.Actor_STATUS_PAUSING || state.Actor.GetStatus() == runtimeapipb.Actor_STATUS_PAUSED, nil
}
func (s *MarkPausingStep) Execute(ctx context.Context, input *PauseInput, state *PauseState) error {
	...
	state.Actor.Status = runtimeapipb.Actor_STATUS_PAUSING
...
type CallWorkerPauseStep struct {
	dialer *WorkerDialer
}
...
func (s *CallWorkerPauseStep) RetryBackoff() *wait.Backoff { return nil }
...
func (s *FinalizePausedStep) IsComplete(ctx context.Context, input *PauseInput, state *PauseState) (bool, error) {
	...
	return state.Actor.GetStatus() == runtimeapipb.Actor_STATUS_PAUSED && state.Actor.GetSandboxPodNamespace() == "", nil
}
func (s *FinalizePausedStep) Execute(ctx context.Context, input *PauseInput, state *PauseState) error {
	...
	if latestActor.GetSandboxPodNamespace() != "" {
		...
		latestActor.Status = runtimeapipb.Actor_STATUS_PAUSED
