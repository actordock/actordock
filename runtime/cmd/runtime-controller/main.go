...
import (
	...
	"github.com/actordock/runtime/cmd/runtime-controller/internal/controllers"
	clientv1alpha1 "github.com/actordock/runtime/pkg/api/v1alpha1"
...
var (
	...
	runtimeAPIConnSpec = pflag.String("runtime-api-conn-spec", "dns:///api.actordock-system.svc:443", "")
)
...
func main() {
	...
	runtimeAPIClient := runtimeapipb.NewControlClient(runtimeAPIConn)
