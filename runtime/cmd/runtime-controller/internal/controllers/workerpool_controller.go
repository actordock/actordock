...
//+kubebuilder:rbac:groups=actordock.dev,resources=workerpools/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=actordock.dev,resources=workerpools/finalizers,verbs=update
...
func (r *WorkerPoolReconciler) reconcileWorkerPool(ctx context.Context, wp *runtimev1alpha1.WorkerPool) error {
	log := log.FromContext(ctx)
...
func (r *WorkerPoolReconciler) applyDeployment(ctx context.Context, wp *runtimev1alpha1.WorkerPool) error {
...
func (r *WorkerPoolReconciler) syncStatus(ctx context.Context, wp *runtimev1alpha1.WorkerPool, dep *appsv1.Deployment) error {
	want := runtimev1alpha1.WorkerPoolStatus{Replicas: dep.Status.Replicas}
...
func (r *WorkerPoolReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&runtimev1alpha1.WorkerPool{}).
