...
func (s *Service) ListActors(ctx context.Context, req *runtimeapipb.ListActorsRequest) (*runtimeapipb.ListActorsResponse, error) {
	...
	return &runtimeapipb.ListActorsResponse{
		Actors:        actors,
		NextPageToken: nextToken,
	}, nil
}

func validateListActorsRequest(req *runtimeapipb.ListActorsRequest) error {
	pageSize := req.GetPageSize()
	if pageSize < 0 {
