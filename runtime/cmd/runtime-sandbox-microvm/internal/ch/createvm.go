...
// VmConfig runtime-sandbox sets to boot the kata guest. Modeled on kata's clh driver
...
// rest of runtime-sandbox relies on).
...
// runtime-sandbox then dials (DialAgent) to drive the agent.
