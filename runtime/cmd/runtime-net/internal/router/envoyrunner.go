...
const (
	EnvoyDeploymentName = "runtime-net-router-envoy"
	EnvoyServiceName    = "runtime-net-router-envoy"
	EnvoyConfigMapName  = "runtime-net-router-envoy-config"
)
...
node:
  id: %s
  cluster: actordock-router-cluster
