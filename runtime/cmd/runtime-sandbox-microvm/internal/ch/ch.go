...
//
// This is the snapshot/restore half of the runtime-sandbox-microvm model: kata
// owns RUN (boot the micro-VM + run the OCI container), and runtime-sandbox drives the CH
