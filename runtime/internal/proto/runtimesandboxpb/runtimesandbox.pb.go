...
const file_runtimesandbox_proto_rawDesc = "" +
	"\n" +
	"\x14runtimesandbox.proto\x12\x18actordock.runtimesandbox\"\xf4\x01\n" +
	...
	"\x04spec\x18\x05 \x01(\v2&.actordock.runtimesandbox.WorkloadSpecR\x04spec\"S\n" +
	"\fWorkloadSpec\x12C\n" +
	"\n" +
	...
	"\x13RunWorkloadResponse\"\xab\x02\n" +
	...
	"\x1aCheckpointWorkloadResponse\"\xa8\x02\n" +
	...
	"\x17RestoreWorkloadResponse2\xf5\x02\n" +
	"\aSandbox\x12l\n" +
...
var file_runtimesandbox_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_runtimesandbox_proto_goTypes = []any{
	(*RunWorkloadRequest)(nil),         // 0: actordock.runtimesandbox.RunWorkloadRequest
	(*WorkloadSpec)(nil),               // 1: actordock.runtimesandbox.WorkloadSpec
	(*Container)(nil),                  // 2: actordock.runtimesandbox.Container
	(*RunWorkloadResponse)(nil),        // 3: actordock.runtimesandbox.RunWorkloadResponse
	(*CheckpointWorkloadRequest)(nil),  // 4: actordock.runtimesandbox.CheckpointWorkloadRequest
	(*CheckpointWorkloadResponse)(nil), // 5: actordock.runtimesandbox.CheckpointWorkloadResponse
	(*RestoreWorkloadRequest)(nil),     // 6: actordock.runtimesandbox.RestoreWorkloadRequest
	(*RestoreWorkloadResponse)(nil),    // 7: actordock.runtimesandbox.RestoreWorkloadResponse
}
var file_runtimesandbox_proto_depIdxs = []int32{
	1, // 0: actordock.runtimesandbox.RunWorkloadRequest.spec:type_name -> actordock.runtimesandbox.WorkloadSpec
	2, // 1: actordock.runtimesandbox.WorkloadSpec.containers:type_name -> actordock.runtimesandbox.Container
	1, // 2: actordock.runtimesandbox.CheckpointWorkloadRequest.spec:type_name -> actordock.runtimesandbox.WorkloadSpec
	1, // 3: actordock.runtimesandbox.RestoreWorkloadRequest.spec:type_name -> actordock.runtimesandbox.WorkloadSpec
	0, // 4: actordock.runtimesandbox.Sandbox.RunWorkload:input_type -> actordock.runtimesandbox.RunWorkloadRequest
	4, // 5: actordock.runtimesandbox.Sandbox.CheckpointWorkload:input_type -> actordock.runtimesandbox.CheckpointWorkloadRequest
	6, // 6: actordock.runtimesandbox.Sandbox.RestoreWorkload:input_type -> actordock.runtimesandbox.RestoreWorkloadRequest
	3, // 7: actordock.runtimesandbox.Sandbox.RunWorkload:output_type -> actordock.runtimesandbox.RunWorkloadResponse
	5, // 8: actordock.runtimesandbox.Sandbox.CheckpointWorkload:output_type -> actordock.runtimesandbox.CheckpointWorkloadResponse
	7, // 9: actordock.runtimesandbox.Sandbox.RestoreWorkload:output_type -> actordock.runtimesandbox.RestoreWorkloadResponse
