...
func TestCreateActor_Success(t *testing.T) {
	...
	expected := proto.Clone(actor).(*runtimeapipb.Actor)
	expected.Version = 1
...
func TestUpdateActor_Success(t *testing.T) {
	...
	actor.Status = runtimeapipb.Actor_STATUS_RUNNING
	actor.Version = 1
...
func TestUpdateActor_Conflict(t *testing.T) {
	...
	// Update instance 1
	actor1.Status = runtimeapipb.Actor_STATUS_RUNNING
	...
	actor2.Status = runtimeapipb.Actor_STATUS_SUSPENDED
...
func TestListWorkers(t *testing.T) {
	...
	worker1 := &runtimeapipb.Worker{
		WorkerNamespace: "ns1",
		WorkerPool:      "pool1",
		WorkerPod:       "pod1",
	}
	worker2 := &runtimeapipb.Worker{
		WorkerNamespace: "ns1",
		WorkerPool:      "pool1",
		WorkerPod:       "pod2",
	}
