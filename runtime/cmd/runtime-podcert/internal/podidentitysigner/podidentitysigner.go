...
import (
	...
	"github.com/actordock/runtime/cmd/runtime-podcert/internal/podcertificate"
...
const Name = "podidentity.podcert.actordock.dev/identity"
const CTBPrefix = "podidentity.podcert.actordock.dev:identity:"
	...
	wantCTB := &certsv1beta1.ClusterTrustBundle{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				"podcert.actordock.dev/canarying": "live",
			},
		},
