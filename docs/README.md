...
| `architecture/` | How the runtime/control plane supports the research (incl. [signal-plugins.md](./architecture/signal-plugins.md), [semantic-score.md](./architecture/semantic-score.md)) |
