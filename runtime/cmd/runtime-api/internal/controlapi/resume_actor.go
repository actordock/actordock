...
func (s *Service) ResumeActor(ctx context.Context, req *runtimeapipb.ResumeActorRequest) (*runtimeapipb.ResumeActorResponse, error) {
	...
	return &runtimeapipb.ResumeActorResponse{Actor: actor}, nil
}

func validateResumeActorRequest(req *runtimeapipb.ResumeActorRequest) error {
	if req.GetActorId() == "" {
