...
func (s *Service) CreateActor(ctx context.Context, req *runtimeapipb.CreateActorRequest) (*runtimeapipb.CreateActorResponse, error) {
	...
	return &runtimeapipb.CreateActorResponse{
		Actor: storedActor,
	}, nil
}

func validateCreateActorRequest(req *runtimeapipb.CreateActorRequest) error {
...
func validateSelector(sel *runtimeapipb.Selector) error {
