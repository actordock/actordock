...
import (
	...
	"github.com/actordock/runtime/cmd/runtime-api/internal/k8sjwt"
	"github.com/actordock/runtime/cmd/runtime-api/internal/sessionidjwt"
...
// Server implements runtimeapipb.SessionIdentityServer
type Server struct {
	runtimeapipb.UnimplementedSessionIdentityServer
...
var _ runtimeapipb.SessionIdentityServer = (*Server)(nil)
...
func (s *Server) MintJWT(ctx context.Context, req *runtimeapipb.MintJWTRequest) (*runtimeapipb.MintJWTResponse, error) {
	...
	sessionClaims := &sessionidjwt.Claims{
		Issuer:     "https://broker.actordock-session-id-broker.svc", // TODO: This needs to be globally unique.
		...
		Actordock: sessionidjwt.ActordockClaims{
			AppID:     req.GetAppId(),
	...
	return &runtimeapipb.MintJWTResponse{
		SessionJwt: sessionJWT,
	}, nil
}

func (s *Server) MintCert(ctx context.Context, req *runtimeapipb.MintCertRequest) (*runtimeapipb.MintCertResponse, error) {
	...
	template := &x509.Certificate{
		...
		IsCA:                  false,
		Issuer: pkix.Name{
			CommonName: "api.actordock-system.svc.cluster.local",
		},
	}
	...
	return &runtimeapipb.MintCertResponse{
