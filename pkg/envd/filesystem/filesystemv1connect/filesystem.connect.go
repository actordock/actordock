...
import (
	...
	context "context"
	errors "errors"
	filesystem "github.com/actordock/actordock/pkg/envd/filesystem"
	http "net/http"
	strings "strings"
)
...
func NewFilesystemClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FilesystemClient {
	...
	filesystemMethods := filesystem.File_proto_envd_filesystem_filesystem_proto.Services().ByName("Filesystem").Methods()
