...
func (s *Service) UpdateActor(ctx context.Context, req *runtimeapipb.UpdateActorRequest) (*runtimeapipb.UpdateActorResponse, error) {
	...
	return &runtimeapipb.UpdateActorResponse{Actor: actor}, nil
}

func validateUpdateActorRequest(req *runtimeapipb.UpdateActorRequest) error {
	if req.GetActorId() == "" {
