...
// Package kata holds the helpers runtime-sandbox uses to boot and drive a kata guest in a
// cloud-hypervisor micro-VM without the kata shim: runtime-sandbox boots cloud-hypervisor
...
// sandbox with the given id (the per-sandbox runtime dir). runtime-sandbox records the
